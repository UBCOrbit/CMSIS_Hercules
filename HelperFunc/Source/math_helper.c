/* ----------------------------------------------------------------------
* Copyright (c) 2009-2010 ARM, Inc. All Rights Reserved. This software is 
* proprietary and confidential to ARM, Inc. and its licensors.

* Portions Copyright (c) 2009-2010 ARM, Inc.
* Developed by ARM Cambridge,


* $Date:  		
* $Revision: 

* Project:      Cortex-R4 DSP Software Library    
* Title:	    math_helper.c		
* Author(s):      
* Revised by:		

* Description:	This file has all the math functions required
*				arm_snr_f32()
*				
* References:

* Target Processor:          Cortex-R4
* Target Tools Revision:     RVDS V4.0
* -------------------------------------------------------------------- */
