  ...
  {     
    ...
    *pErr++ = (q31_t) e;     
    ...
    {  
		...
		coef0 = (q31_t) (((q63_t) alpha * x0) >> (32));  
		coef1 = (q31_t) (((q63_t) alpha * x1) >> (32));  
  
		c0 = clip_q63_to_q31((q63_t)c0 + (coef0 << 1u));  
		c1 = clip_q63_to_q31((q63_t)c1 + (coef1 << 1u));  
