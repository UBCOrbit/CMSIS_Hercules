 ...
 *  Input, output, scratch buffers should be aligned by 32-bit  
 *  
 * \par Restrictions  
...
//	*pOut = (__SSATA(acc0, 15u, 16));  
	*pOut = (__SSATA(acc0 >> 15u, 0, 16));  //JMM August 15 2012
	pOut += inc;  
//	*pOut = (__SSATA(acc1, 15u, 16));  
	*pOut = (__SSATA(acc1 >> 15u, 0, 16));  //JMM August 15 2012  
	pOut += inc;  
//	*pOut = (__SSATA(acc2, 15u, 16));  
	*pOut = (__SSATA(acc2 >> 15u, 0, 16));  //JMM August 15 2012  
	pOut += inc;  
//	*pOut = (__SSATA(acc3, 15u, 16));  
	*pOut = (__SSATA(acc3 >> 15u, 0, 16));  //JMM August 15 2012  
	pOut += inc;  
#else  
