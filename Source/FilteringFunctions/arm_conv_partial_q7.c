...
//	  out3 = (q7_t) (__SSATA(acc3, 7u, 8));  
	  out0 = (q7_t) (__SSATA(acc0 >> 7u, 0, 8));  //JMM August 15 2012
	  out1 = (q7_t) (__SSATA(acc1 >> 7u, 0, 8));  //JMM August 15 2012  
	  out2 = (q7_t) (__SSATA(acc2 >> 7u, 0, 8));  //JMM August 15 2012
	  out3 = (q7_t) (__SSATA(acc3 >> 7u, 0, 8));  //JMM August 15 2012  
#else  
...
//   *pOut++ = (q7_t) (__SSATA(acc0, 7u, 8));  
   *pOut++ = (q7_t) (__SSATA(acc0 >> 7u, 0, 8));  //JMM August 15 2012
#else  
