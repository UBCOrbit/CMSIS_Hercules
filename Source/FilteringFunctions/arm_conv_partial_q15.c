 ...
 * \par Alignment of buffers  
 *  To get best performance of cycles input, output, scratch1 and scratch2 buffers should be   
 *  aligned by 32-bit  
 *      
...
//			__PKHBT(__SSATA(acc2, 15, 16), __SSATA(acc3, 15, 16), 16);  
		  *__SIMD32(pOut)++ = __PKHBT(__SSATA(acc0 >> 15, 0, 16), __SSATA(acc1 >> 15, 0, 16), 16);  //JMM August 15 2012
...
//			__PKHBT(__SSATA(acc3, 15, 16), __SSATA(acc2, 15, 16), 16);  
		  *__SIMD32(pOut)++ = __PKHBT(__SSATA(acc1 >> 15, 0, 16), __SSATA(acc0 >> 15, 0, 16), 16);  //JMM August 15 2012
...
//		*pOut++ = __SSATA(acc3, 15, 16);  
		*pOut++ = __SSATA(acc0 >> 15, 0, 16);    //JMM August 15 2012 
		*pOut++ = __SSATA(acc1 >> 15, 0, 16);    //JMM August 15 2012 
		*pOut++ = __SSATA(acc2 >> 15, 0, 16);    //JMM August 15 2012 
		*pOut++ = __SSATA(acc3 >> 15, 0, 16);    //JMM August 15 2012 
	#else  
